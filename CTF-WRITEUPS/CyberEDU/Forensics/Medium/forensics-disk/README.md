# forensics-disk - CyberEDU | Forensics | Medium | Writeup

**DESCRIEREA EXERCITIULUI:**

Poţi recupera secretul din interior?
...
Observam ca avem 3 imagini, cred ca 3 diferite, fata de celalalt.
...
2. Analizam imaginile extrase, dar observam ca nu arata nimic, e ca niste pagini goale, 
   ...
   Si ne afiseaza:
                  ...
                  new_1.jpg: JPEG image data, JFIF standard 1.01, aspect ratio, density 1x1 
...
4. Iar acum ca sa remodificat extensiile, ar trebui sa si functioneze imaginea sa o putem vizualiza:
  ...
  Si ultima imagine o vedem, dar o parte e cam stearsa, dar ne putem da seama ce ar trebui sa scrie la acel flag asa cum e la new_2.jpg
